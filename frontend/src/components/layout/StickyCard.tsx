...
export function StickyCard({ onFeedbackClick }: StickyCardProps) {
      ...
      >
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <motion.button
            ...
            className="flex items-center gap-3 p-3 rounded-lg hover:bg-emerald-50 dark:hover:bg-emerald-950/20 transition-colors group w-full text-left"
            whileHover={{ x: 4, scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
            <motion.div
